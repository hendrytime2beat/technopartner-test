...
<html lang="en">
  <head>
    ...
    <title>{{ $title }} - Manajemen Keuangan Technopartner</title>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      ...
      <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link menu-user" data-id="user" href="{{ route('user')}}">
          ...
          @endif
          <li class="nav-item">
            <a class="nav-link menu-list" data-id="list" href="{{ route('income')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
          ...
          <li class="nav-item">
            <a class="nav-link menu-expenditure" data-id="expenditure" href="{{ route('expenditure')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <li class="nav-item">
            <a class="nav-link menu-report" data-id="report" href="{{ route('report')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
            ...
            <div class="row align-items-center justify-content-lg-between">
              <div class="col-lg-6 mb-lg-0 mb-4">
                <div class="copyright text-center text-sm text-muted text-lg-start"> © <script>
                  ...
                  </script> Manajemen Keuangan Technopartner</a> </div>
              </div>
            </div>
          </div>
        </footer>
